...
Consult the [ThreeFoldTech TFCMD repository](https://github.com/threefoldtech/zos_sdk_go/tree/development/grid-cli) for the latest updates. Make sure to read the [basics](../../system_administrators/tfgrid3_getstarted/tfgrid3_getstarted.md).
